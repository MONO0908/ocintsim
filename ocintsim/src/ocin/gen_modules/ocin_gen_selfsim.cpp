...
void ocin_gen_selfsim::init (tsim_object *parent, string _name) {
...
/*
  ...
  for (int x = 0; x <packet_count;x++) {
    double selfrand2 = gen_rand(2);

    src_idx = (unsigned)(selfrand2*src_count);
    if(src_idx == 64) {
      src_idx = 63;
    }
*/
...
void ocin_gen_selfsim::finalize() {
}
