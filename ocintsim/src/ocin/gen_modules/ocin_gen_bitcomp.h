#ifndef OCIN_GEN_BITCOMP_H_
#define OCIN_GEN_BITCOMP_H_
...
class ocin_gen_bitcomp : public ocin_gen {
 public:
  ...
  ocin_gen_bitcomp(map<string, ocin_router> &_nodes, 
