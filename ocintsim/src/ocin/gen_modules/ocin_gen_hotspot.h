#ifndef OCIN_GEN_HOTSPOT_H_
#define OCIN_GEN_HOTSPOT_H_
...
class ocin_gen_hotspot : public ocin_gen {
 public:

  /* pointer to ocin_top */
  ocin_top *top_p;

  /* Vector of the hotspot names */
  vector<string> hs_names;

  /* vector of pointers to local_iu's: */
  vector<ocin_router_inj *> local_iu_ptrs;

  /* initialize the refs on instantiation */
  ocin_gen_hotspot(map<string, ocin_router> &_nodes, 
