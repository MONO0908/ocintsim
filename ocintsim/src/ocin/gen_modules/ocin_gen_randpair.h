#ifndef OCIN_GET_RANDPAIR_H_
#define OCIN_GET_RANDPAIR_H_
...
class ocin_gen_randpair : public ocin_gen {
 public:
  ...
  ocin_gen_randpair(map<string, ocin_router> &_nodes, 
  ...
  unsigned revbits(unsigned value, unsigned maxval);


};

#endif /*OCIN_GET_RANDPAIR_H_*/
