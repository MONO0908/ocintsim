#ifndef OCIN_GET_BITREV_H_
#define OCIN_GET_BITREV_H_
...
class ocin_gen_bitrev : public ocin_gen {
 public:
  ...
  ocin_gen_bitrev(map<string, ocin_router> &_nodes, 
