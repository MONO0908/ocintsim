#ifndef OCIN_ROUTER_COST_MGR_1D_H_
#define OCIN_ROUTER_COST_MGR_1D_H_
...
class ocin_router_cost_mgr_1D : public ocin_router_cost_mgr {
public:
  
  ocin_router_cost_mgr_1D(vector <vector <ocin_router_cost_reg> > &cost_regs)
...
#endif /*OCIN_ROUTER_COST_MGR_1D_H_*/
