#ifndef OCIN_ROUTER_XBALLOC_BEC_2LEVEL_H_
#define OCIN_ROUTER_XBALLOC_BEC_2LEVEL_H_
...
class ocin_router_xballoc_bec_2level : public ocin_router_xballoc {
  public:
    
    ocin_router_xballoc_bec_2level(vector <vector <ocin_router_vc_fifo> > &vc_fifos,
...
#endif /*OCIN_ROUTER_XBALLOC_BEC_2LEVEL_H_*/
